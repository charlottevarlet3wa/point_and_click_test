  ...
  if (selectedItemInHand && selectedItemInHand.weight) {
    ...
    itemImage.addEventListener("click", function () {
      ...
      weightDisplay.textContent =
        parseInt(weightDisplay.textContent) - selectedItemInHand.weight;
    ...
    objects: [
      {
        ...
        base: "arrow_door",
        style:
          "width: 40px; height: 40px; transform:rotateY(180deg);top:3px; left: 3px;",
        targetScene: "village",
      },
      {
        id: "black-potion",
...
closeMessageBtn.addEventListener("click", (e) => {
  ...
  switch (tutoStep) {
    ...
    case "collect":
      displayMessage(
        `Les champignons ont été ajoutés à ton inventaire. Clique sur l’icône sac à dos.`
      );
      tutoStep = tutoSteps[2];
      break;
    case "hand":
      displayMessage(
        `Fais glisser un champignon jusqu'à le déposer dans ta main (cases en bas à droite).`
      );
